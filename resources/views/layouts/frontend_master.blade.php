                    ...
                    <div class="col-md-6 col-12">
                        <ul class="d-flex account_login-area">
                            ...
                            <li>
                                  ...
                                  <a href="{{ url('customar/register') }}">Customar Register </a>
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                  ...
                                  @foreach (App\Cart::where('ip_address', request()->ip())->get() as $cart)
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img width="100" src="{{ asset('uploads\product') }}/{{ App\Product::find($cart->product_id)->product_thumbnail_photo }}" alt="">
                                        </div>
                                        <div class="cart-content">
                                  ...
                                  @endforeach
                                    ...
                                    <li>
                                        <a href="{{ url('cart') }}" class="btn bg-white text-dark">Cart</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
