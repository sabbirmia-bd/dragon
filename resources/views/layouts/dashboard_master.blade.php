  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="{{ asset('home') }}" class="sl-menu-link @yield('home')">
        ...
        <a href="{{ asset('add/category') }}" class="sl-menu-link @yield('category')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Category</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ asset('add/product') }}" class="sl-menu-link @yield('product')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Product</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ asset('add/coupon') }}" class="sl-menu-link @yield('coupon')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Coupon</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ asset('message/list') }}" class="sl-menu-link @yield('message/list')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Message List</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ asset('contact/info') }}" class="sl-menu-link @yield('contact_info')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Contact info</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ asset('add/testmonial') }}" class="sl-menu-link @yield('testmonial')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Testmonial</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ url('add/about') }}" class="sl-menu-link @yield('about')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{ url('comment/list') }}" class="sl-menu-link @yield('comment')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Comment List</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('add/blog') }}" class="nav-link @yield('blog')">Add Blog Post</a></li>
          <li class="nav-item"><a href="{{ url('blog/list') }}" class="nav-link @yield('blog_list')">Blog post list</a></li>
        </ul>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{ asset('profile/edit') }}"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
