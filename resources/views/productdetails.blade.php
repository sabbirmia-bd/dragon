                 ...
                 <div class="col-lg-6">
                     <div class="product-single-img">
                         <div class="product-active owl-carousel">
                             <div class="item">
                                 <img src="{{ asset('uploads/product') }}/{{ $product_info->product_thumbnail_photo }}" alt="">
                             </div>
                             @foreach ($multiple_photos as $multiple_photo)
                               <div class="item">
                                 <img src="{{ asset('uploads\multiple_photos') }}/{{ $multiple_photo->photo_name }}" alt="">
                             </div>
                             @endforeach
                     ...
                     <div class="product-single-content">
                         ...
                         <ul class="input-style">
                           @if ($product_info->product_quantity == 0)
                             <div class="alert alert-danger">
                               This product currently out of stack
                             </div>
                             @else
